...
public class UserInfoController {
	...
	public ResponseEntity<UserInfoDto>  selectUserInfo(@PathVariable String name){
		
		return ResponseEntity.status(HttpStatus.OK).body(userInfoService.selectUserInfo(name)); 
	} 
